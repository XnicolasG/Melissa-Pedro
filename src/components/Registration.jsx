...
export const Registration = () => {
    ...
    return (
        <>
        <br id="Registro" />
            <section  className="flex flex-col my-8 w-[90%] md:w-3/3 mx-auto ">
                ...
                <div className="flex flex-col  gap-6 px-4 py-2">
                    ...
                    <p className="flex flex-wrap px-4 items-center text-pretty text-gray-500">
                        Registra tu asistencia en el formulario <span className="hidden sm:flex"> ⬇️ </span> o contáctanos por WhatsApp si tienes dudas sobre la boda.
                        <a
                            className="flex-inline md:mx-2 items-center gap-x-2 px-1 py-1 rounded-full ring-1 bg-emerald-700 ring-emerald-900 hover:scale-105 transition-all duration-150"
