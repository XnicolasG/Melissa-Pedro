            ...
            breakpoints.map((item, index) => (
              ...
              <li key={index} class="relative w-20 md:w-28 lg:w-36 mb-6 sm:mb-0 flex-1 ">
                <div class="flex items-center ">
                  <div class="z-10 flex items-center justify-center size-10 bg-blue-100 rounded-full ring-0 ring-white dark:bg-blue-900 sm:ring-8 dark:ring-gray-900 shrink-0">
